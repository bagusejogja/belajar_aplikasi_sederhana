          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl font-bold text-xs transition-all duration-200 select-none cursor-pointer ${
                isActive
                  ? 'bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-700 text-white shadow-md shadow-blue-200/70 ring-1 ring-blue-500/40 scale-[1.02]'
                  : 'bg-slate-50/90 hover:bg-blue-50/70 text-slate-700 hover:text-blue-700 border border-slate-200/80 hover:border-blue-200 hover:shadow-2xs active:scale-95'
              }`}
            >
