...
export default function ReviewAnggaranTabs({ activeTab }: { activeTab?: string }) {
  ...
  return (
    <div className="bg-white/95 backdrop-blur-sm p-3 px-4 md:px-5 rounded-2xl border border-gray-200/90 shadow-xs mb-4">
      ...
      {/* Navigation Pills: Responsive Wrap Layout (No sideways scrolling needed!) */}
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2 px-3.5 py-2 rounded-xl font-bold text-xs transition-all duration-200 select-none cursor-pointer ${
                isActive
                  ? 'bg-gradient-to-r from-indigo-600 via-indigo-600 to-indigo-700 text-white shadow-md shadow-indigo-200/70 ring-1 ring-indigo-500/40 scale-[1.02]'
