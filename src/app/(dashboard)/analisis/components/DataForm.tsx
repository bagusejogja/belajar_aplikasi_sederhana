...
export default function DataForm({ mainData, setMainData, isDetailMode, detailData = [], setDetailData, historisData = [], setHistorisData, section = 'all', readOnly = false }: any) {
  ...
  const handleUnitChange = async (selectedOption: any) => {
    setMainData((prev: any) => ({ ...prev, unit_pengirim: selectedOption?.label || '' }));
      ...
      {showStep3 && (
        <div className="space-y-8">
          ...
          <div className="space-y-8">
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase tracking-widest mb-2">Histori Usulan Tambah Pagu Unit Kerja</label>
