 ...
 <Worksheet ss:Name="Tunjangan Fungsional 2026">
  ...
  <WorksheetOptions xmlns="urn:schemas-microsoft-com:office:excel">
   <PageSetup><Layout x:Orientation="Landscape"/></PageSetup>
      ...
      link.href = url;
      link.download = `Tunjangan_Fungsional_2026.xls`;
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-base font-black text-gray-900 tracking-tight leading-none">Tunjangan Fungsional</h1>
              <span className="px-2 py-0.5 rounded-md bg-indigo-50 text-indigo-700 border border-indigo-200 text-[10px] font-bold">
                Kategori Dosen TA {KONSTANTA.TAHUN_REFERENSI}
              </span>
            </div>
            <p className="text-gray-500 font-medium text-[11px] mt-0.5">Kalkulasi tunjangan jabatan fungsional dosen (termasuk THR dan Gaji 13 PNS)</p>
          </div>
        </div>
              ...
              {isLoading ? (
                <tr>
                  <td colSpan={5} className="py-12 text-center text-gray-400 text-xs">
                    ...
                    Menghitung tunjangan fungsional...
                  </td>
                </tr>
