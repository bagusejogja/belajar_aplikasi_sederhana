      ...
      <div className="relative bg-slate-900 rounded-[4rem] p-12 lg:p-20 overflow-hidden shadow-2xl mb-12 group">
        ...
        <div className="relative z-10 flex flex-col items-start max-w-3xl">
          ...
          <motion.p 
            ...
            className="text-slate-400 text-lg font-medium max-w-xl leading-relaxed mb-10"
          >
            Pusat kendali administrasi terpadu. Selamat bekerja dan kelola semua proses dari satu pintu utama yang modern dan aman.
          </motion.p>
        </div>
      </div>
